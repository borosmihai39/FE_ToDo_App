...
On the Register Page, an unregistered user can sign up for a new account. Certain form validations are put in place *(no empty fields, no existing user)*
...
Upon logging in as the admin user, a new link appears on the Navbar - *Admin dashboard*. On the dashboard, the admin can see messages sent via the contact form.
...
export default FeaturesMarkdown;
